...
public final class Record implements Serializable {
  ...
  public Record(int expiredItems, int numActiveListings, int aHPrice, Float energyPrice, Date timestamp,
      Record previous, Item recordItem) {
    ...
    if(previous == null) {
      ...
      } else if(previous.numFinalListings == previous.maxListings && previous.isRecentEnough(timestamp)
      ...
      netProfit = ((int) ((previous.getNumFinalListings() - numLotsExpired - numActiveListings) * (
    ...
    int undercutMarginPrice =
        (int) (cost * 10f / 9 + (aHPrice * recordItem.getNumItemsPerListing() - cost * 10f / 9) * undercutMargin);
