...
public final class Record implements Serializable {
	...
	public Record(
		...
		if(previous == null){
			...
			if(numLotsExpired > 0){// Expired
				...
				if(previousMaxListings == 0) previousMaxListings = 1;
	...
	public final int getAHPrice(){ return aHPrice; }

	public final int getCost(){ return cost; }

	public final float getCostPlusPercent(){ return costPlusPercent; }
	...
	public final int getListingPrice(){ return listingPrice; }

	public final int getMaxListings(){ return maxListings; }

	public final int getNetProfit(){ return netProfit; }
	...
	private final Record getNotYetExpired(){
		...
		if(returnValue.getPreviousRecord() == null) return returnValue;
		do{
	...
	private final int getNumFinalListings(){ return numFinalListings; }

	public final int getNumListingsNotStocked(){ return maxListings - numFinalListings; }

	public final int getNumListingsToSell(){ return numListingsToSell; }

	private final Record getPreviousRecord(){ return previousRecord; }
	 ...
	 * return null; } private final Record getLastYearRecord() { GregorianCalendar
	 * converter = new GregorianCalendar(); converter.setTime(timestamp); int day =
	...
	private final int getUndercut(){ return undercut; }

	public final float getUndercutMargin(){ return undercutMargin; }
	...
	public final boolean isStocked(){ return stocked; }
	...
	private final void setUndercut(int undercut){
		if((this.undercut == 0 && undercut < price) || (undercut < this.undercut)) this.undercut = undercut;
	}
}
